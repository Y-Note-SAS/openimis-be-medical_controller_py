# Generated by Django 4.2.29 on 2026-08-24 08:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('medical_controller', '0002_historicalmedicalcontrolmission_percentage_four_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='MissionActivityHistory',
            fields=[
                ...
                ('action', models.TextField(blank=True, db_column='Action', max_length=100, null=True)),
                ('action_date', models.DateTimeField(blank=True, db_column='ActionDate', default=django.utils.timezone.now, null=True)),
                ('mission', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='activity_mission_hf', to='medical_controller.medicalcontrolmission')),
        ...
        migrations.CreateModel(
            name='HistoricalMissionActivityHistory',
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, db_column='userID', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
            ...
            options={
                'verbose_name': 'historical mission activity history',
                'verbose_name_plural': 'historical mission activity historys',
